...
export class CommonService {
    ...
    public getUserBranches = (): Observable<Base> => this.createHttpRequest('GET', 'getUserBranches');
    public getUsers =(): Observable<Base> => this.createHttpRequest('GET', 'getCountries');
}